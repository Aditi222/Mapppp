...
public class MostViewedAdpater extends RecyclerView.Adapter<MostViewedAdpater.MostViewedViewHolder>{
    ArrayList<com.adarsh.chargecity.HelperClasses.HomeAdapter.MostViewedHelperClass> mostViewedLocations;
    public MostViewedAdpater(ArrayList<com.adarsh.chargecity.HelperClasses.HomeAdapter.MostViewedHelperClass> mostViewedLocations) {
    ...
    public void onBindViewHolder(@NonNull MostViewedViewHolder holder, int position) {
        com.adarsh.chargecity.HelperClasses.HomeAdapter.MostViewedHelperClass helperClass = mostViewedLocations.get(position);
