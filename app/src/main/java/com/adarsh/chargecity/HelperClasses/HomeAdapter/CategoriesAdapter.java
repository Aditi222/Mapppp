...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.AdapterAllCategoriesViewHolder> {
    ArrayList<com.adarsh.chargecity.HelperClasses.HomeAdapter.CategoriesHelperClass> mostViewedLocations;
    public CategoriesAdapter(ArrayList<com.adarsh.chargecity.HelperClasses.HomeAdapter.CategoriesHelperClass> mostViewedLocations) {
    ...
    public void onBindViewHolder(@NonNull AdapterAllCategoriesViewHolder holder, int position) {
        com.adarsh.chargecity.HelperClasses.HomeAdapter.CategoriesHelperClass helperClass = mostViewedLocations.get(position);
    ...
    public static class AdapterAllCategoriesViewHolder extends RecyclerView.ViewHolder {
        ...
        public AdapterAllCategoriesViewHolder(@NonNull View itemView) { super(itemView);
